...
const Background = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden formobile absolute bottom-[5%] block text-center w-full">
        <button
          onMouseDown={() => handleMouseDown("ArrowUp")}
          onMouseUp={() => handleMouseUp("ArrowUp")}
          className="px-[10px] py-[10px] bg-green-500 rounded-full m-[9px] border-none down"
        >
          <AiOutlineUp />
        </button>
        <br />
        <button
          ...
          className="px-[10px] py-[10px] bg-green-500 rounded-full mr-[100px] m-[9px] border-none left"
        >
          <AiOutlineLeft />
        </button>
        <button
          ...
          className="px-[10px] py-[10px] bg-green-500 rounded-full mr-[10px] m-[9px] border-none right"
        >
          <AiOutlineRight />
        </button>
        <br />
